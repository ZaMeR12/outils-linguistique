...
import TradCarte from "@/components/historique/details/TradCarte.components";
      ...
      >
        ...
        <Grid size={12} paddingBottom={2}>
          <Typography variant="body1" component="p">
            Voici les détails de la traduction. Pour voir l'historique de vos
            interactions avec l'application, retournez à la page précédente.
          </Typography>
        </Grid>
        <Grid size={12}>
          <TradCarte id={id ? parseInt(id) : 0} />
        </Grid>
      </Grid>
    </div>
  );
