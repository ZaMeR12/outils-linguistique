...
import SynthCarte from "@/components/historique/details/SynthCarte.components";
      ...
      >
        ...
        <Grid size={12} paddingBottom={2}>
          <Typography variant="body1" component="p">
            Voici les détails de la synthèse. Pour voir l'historique de vos
            interactions avec l'application, retournez à la page précédente.
          </Typography>
        </Grid>
        <Grid size={12}>
          <SynthCarte id={id ? parseInt(id) : 0} />
        </Grid>
      </Grid>
    </div>
  );
